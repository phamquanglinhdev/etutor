    ...
    @else
        ...
        <div class="list">
            ...
            @if(!backpack_auth()->check())
                <script>
                    $('#preview a').removeAttr('href');

                    $("#preview a").click(function () {
                        swal({
                            title: "Bạn chưa đăng nhập",
                            text: "Vui lòng đăng nhập để xem bài giảng nhé",
                            icon: "info",
                            ...
                            .then((willDelete) => {
                                if (willDelete) {
                                    window.open('{{route('backpack.auth.login')}}', '_blank')
                                    target = "_blank"
                                    swal({
                                        title: "Đăng nhập rồi thì load lại trang nhé ",
                                        button: "OK"
                                    })
                                        .then((willDelete) => {
                                                if (willDelete) {
